    ...
    <div class="container-full" id="container">
        <div class="content" id="content">
            <div class="inner">
                ...
                <ul class="tab-list">
                    <li class="on"><a href="http://test.hackers.com/find/findId.php">아이디 찾기</a></li>
                    <li><a href="http://test.hackers.com/find/findPW.php">비밀번호 찾기</a></li>
                </ul>
                ...
                <div class="box-btn mt30">
                    <a class="btn-l" href="#">로그인하러 가기</a>
                    <a class="btn-l-line ml5" href="#">비밀번호 찾기</a>
                </div>
